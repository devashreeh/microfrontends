...
exports.default = (0, create_eslint_rule_1.createESLintRule)({
    ...
    create(context) {
        ...
        const { generatorsJson, executorsJson, migrationsJson, packageJson } = normalizeOptions(sourceProject, context.options[0]);
...
function validateVersionJsonExpression(node) {
    return (node &&
